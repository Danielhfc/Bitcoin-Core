...
const static MaybeCoin SPENT_DIRTY        = CoinEntry{SPENT, CoinEntry::State::DIRTY};
const static MaybeCoin SPENT_DIRTY_FRESH  = CoinEntry{SPENT, CoinEntry::State::DIRTY_FRESH};
const static MaybeCoin SPENT_FRESH        = CoinEntry{SPENT, CoinEntry::State::FRESH};
const static MaybeCoin SPENT_CLEAN        = CoinEntry{SPENT, CoinEntry::State::CLEAN};
const static MaybeCoin VALUE1_DIRTY       = CoinEntry{VALUE1, CoinEntry::State::DIRTY};
const static MaybeCoin VALUE1_DIRTY_FRESH = CoinEntry{VALUE1, CoinEntry::State::DIRTY_FRESH};
const static MaybeCoin VALUE1_FRESH       = CoinEntry{VALUE1, CoinEntry::State::FRESH};
const static MaybeCoin VALUE1_CLEAN       = CoinEntry{VALUE1, CoinEntry::State::CLEAN};
const static MaybeCoin VALUE2_DIRTY       = CoinEntry{VALUE2, CoinEntry::State::DIRTY};
const static MaybeCoin VALUE2_DIRTY_FRESH = CoinEntry{VALUE2, CoinEntry::State::DIRTY_FRESH};
const static MaybeCoin VALUE2_FRESH       = CoinEntry{VALUE2, CoinEntry::State::FRESH};
const static MaybeCoin VALUE2_CLEAN       = CoinEntry{VALUE2, CoinEntry::State::CLEAN};
const static MaybeCoin VALUE3_DIRTY       = CoinEntry{VALUE3, CoinEntry::State::DIRTY};
const static MaybeCoin VALUE3_DIRTY_FRESH = CoinEntry{VALUE3, CoinEntry::State::DIRTY_FRESH};
